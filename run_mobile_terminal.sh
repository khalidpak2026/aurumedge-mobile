...
BUILD_VERSION = "5.1.0-mobile-safari"
...
.js-plotly-plot .plotly .modebar{transform:scale(.9);transform-origin:right top}.mobile-callout{padding:11px 12px;border-radius:12px;border:1px solid rgba(244,200,91,.2);background:rgba(244,200,91,.06);color:#cbd5e1;font-size:.7rem;line-height:1.45}.mobile-footer{text-align:center;color:#65758b;font-size:.6rem;margin:18px 0 4px}.svg-chart-shell{width:100%;overflow:hidden;border:1px solid var(--line);border-radius:16px;background:#07101d;box-shadow:0 12px 34px rgba(0,0,0,.22)}.mobile-market-svg,.mobile-mini-svg{display:block;width:100%;height:auto;min-height:250px}.svg-chart-error{padding:18px;border-radius:14px;background:rgba(255,93,125,.10);border:1px solid rgba(255,93,125,.25);color:#ff8da3;font-weight:700}
...
with chart_tab:
    ...
    st.caption("Safari-safe chart: candles, EMA20/50/200, VWAP, Supertrend, volume, support, resistance and liquidity levels. Rotate the iPhone for a wider view.")
